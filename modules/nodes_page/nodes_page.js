...
function handleContextAction(action) {
    if (selectedNodeId) {
        switch (action) {
            ...
            case 'add_stack':
                ...
                break;
            case 'show_racks':
                if (typeof openRackPanelForNode === 'function') openRackPanelForNode(selectedNodeId);
                else showToast('Модуль стойки не загружен', 'warning');
                break;
    ...
    break;
            ...
            case 'show_rack':
                // Окно откроется на шкафу этого устройства и подсветит его блок
