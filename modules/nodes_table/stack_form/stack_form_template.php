<!-- modules/nodes_table/stack_form/stack_form_template.php -->
<div class="dossier-section">
    <h4>📦 Основная информация стека</h4>
    <div class="dossier-grid">
        <div class="form-group">
            <label>IP-адрес</label>
            <select id="stack-ip" class="dossier-select" data-source="ip_address_list"></select>
        </div>
        <div class="form-group">
            <label>Имя хоста</label>
            <input type="text" id="stack-hostname" class="dossier-input" placeholder="Введите общее имя">
        </div>
        <div class="form-group">
