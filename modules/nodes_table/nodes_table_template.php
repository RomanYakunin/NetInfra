    ...
    <div class="buildings-sidebar" id="buildingsSidebar">
        ...
        <ul class="buildings-list">
            ...
            <?php foreach ($buildings as $building): ?>
               <li class="building-item <?= $buildingFilter == $building['id'] ? 'active' : '' ?>"
    onclick="filterByBuilding(<?= $building['id'] ?>)"
    oncontextmenu="return showBuildingContextMenu(event, <?= $building['id'] ?>)">
